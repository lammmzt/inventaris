    ...
    public array $globals = [
        ...
        'after' => [
            ...
            'filterPetugasBOS' => ['except' => [    
                '/', 'Auth/logout','Auth/login', 'PetugasBOS/Dashboard', 'PetugasBOS/ATK/Transaksi', 'PetugasBOS/ATK/Transaksi/*', 'PetugasBOS/Pengadaan', 'PetugasBOS/Pengadaan/*', 'Admin/ATK/Transaksi/DataTablesKeluar', 'Admin/ATK/Transaksi/edit', 'Admin/ATK/Transaksi/fetchDetailTransByIdTrans','Admin/ATK/Transaksi/edit', 'Admin/ATK/Transaksi/fetchDetailTransByIdTrans','Admin/ATK/Transaksi/DataTablesEditTransKeluar', 'Admin/ATK/Transaksi/updateQtyMasuk', 'Admin/ATK/Transaksi/updatedCatatan', 'Admin/Pengadaan/edit', 'Admin/Pengadaan/fetchPengadaanById', 'Admin/Pengadaan/DataTablesDetailPengadaan', 'Admin/Barang/Detail/fetchTipeBarangByJenisBarang', 'Admin/Pengadaan/Delete', 'Admin/Pengadaan/updatePengadaan', 'Admin/Pengadaan/updateQty', 'Admin/Pengadaan/updateSpek', 'Admin/Pengadaan/updateCatatan', 'Admin/Pengadaan/UpdateProsesPenerimaan'
            ]],
        ],
    ];
