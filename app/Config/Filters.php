...
class Filters extends BaseFilters
{
    ...
    public array $globals = [
        ...
        'after' => [
            'filterAdmin' => ['except' => [ 
                '/', 'Auth/logout', 'Auth/login','Admin/Dashboard', 'Admin/Barang', 'Admin/Barang*', 'Admin/Ruangan', 'Admin/Ruangan/*', 'Admin/Satuan', 'Admin/Satuan/*', 'Admin/ATK', 'Admin/ATK/*', 'Admin/Inventaris', 'Admin/Inventaris/*', 'Admin/Pengadaan', 'Admin/Pengadaan/*', 'Admin/User', 'Admin/User/*', 'Admin/Laporan', 'Admin/Laporan/*', 'Admin/Setting', 'getAllDataTras', 'getAllDataTPengecekan',
            ]],
            'filterKaTU' => ['except' => [ 
            ...
            'filterKepsek' => ['except' => [    
                '/', 'Auth/logout','Auth/login', 'Kepsek/Dashboard', 'Kepsek/Laporan/*', 'Kepsek/Setting','Admin/User/updatePass', 'Admin/User/fetchDataUser', 'Admin/Setting', 'Admin/Laporan/ajaxLaporanInventaris', 'Admin/Laporan/ajaxLaporanTransaksi'
            ]],
        ],
    ];
