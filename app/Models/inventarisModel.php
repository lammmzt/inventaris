...
class inventarisModel extends Model
{
    ...
    public function getInventaris($id = false)
    {
        if ($id == false) {
            return $this
                ->select('inventaris.id_inventaris, inventaris.id_tipe_barang, inventaris.id_ruangan, inventaris.harga_inventaris, inventaris.nama_inventaris, inventaris.qty_inventaris, inventaris.qr_code,inventaris.spek_inventaris, inventaris.status_inventaris, inventaris.perolehan_inventaris, inventaris.sumber_inventaris, tipe_barang.nama_tipe_barang, satuan.nama_satuan, ruangan.nama_ruangan, barang.nama_barang')
